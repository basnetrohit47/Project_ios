...
class ViewController: UIViewController, UISearchBarDelegate {
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        let urlRequest = URLRequest(url: URL(string: "http://api.apixu.com/v1/current.json?key=e45f22a960604aa993e201616170401&q=\(searchBar.text!.replacingOccurrences(of: " ", with: "%20"))")!)
